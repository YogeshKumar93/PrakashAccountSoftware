...
// import { ImpsGurusign } from "../iconsImports";
      ...
      >
        <Page size="A4" style={styles.page}>
          ...
          <p style={{ marginBottom: "20px", marginLeft: "20px" }}>
            <strong>Mobifast Solutions Pvt Ltd</strong>, a company incorporated
            under The Companies Act, 2013, having its registered office at Plot
            No. 8, Pocket 6, Sector 22, Rohini, Delhi, 110086.
          </p>
