...
const SuperTransferReceipt = ({ payoutResponse, onRepeat, onNewTxn }) => {
  ...
  const fields = [
    ["Sender Mobile", payoutResponse?.response?.data?.mobileNumber || "N/A"],
    ["Sender Name", payoutResponse?.sender_name || "N/A"],
    [
      "Beneficiary Name",
      payoutResponse?.response?.data?.beneficiaryName || "N/A",
    ],
    [
      "Account Number",
      payoutResponse?.response?.data?.beneficiaryAccount || "N/A",
    ],
    ["Amount", `₹${payoutResponse?.response?.data?.transferAmount || "N/A"}`],
    ["Transfer Mode", payoutResponse?.response?.data?.transferMode || "N/A"],
...
export default SuperTransferReceipt;
